...
(def format-archive-map (assoc archive-map :options {:format "webp"}))
...
(facts :thumbnail-path
       ...
       (thumbnail-path format-archive-map) => "images/thumb/archive/a/ab/12345!boat.jpg/200px-300px-thumbnail[format=webp]-boat.jpg"
